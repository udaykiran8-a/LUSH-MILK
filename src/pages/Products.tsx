...
const ProductCard = ({ product }: { product: any }) => {
  return (
    <Card className="product-card transform transition-all duration-300 hover:scale-105 hover:shadow-xl overflow-hidden bg-white">
      <div className="product-image-container">
        ...
        />
        <Badge className="product-badge bg-lushmilk-terracotta hover:bg-lushmilk-deepred">
          {product.category}
        </Badge>
      </div>
      ...
      <CardFooter className="pt-0">
        <Button className="w-full bg-lushmilk-terracotta hover:bg-lushmilk-brown text-white transition-colors flex items-center justify-center gap-2 rounded-md">
...
const ProductFeatures = () => {
  return (
    <div className="kolam-border bg-white/90 rounded-lg shadow-lg p-6 mb-8">
  ...
  return (
    <Layout>
      <CulturalBackground variant="temple">
        <section className="bg-lushmilk-offwhite py-12 south-indian-border">
      ...
      <CulturalBackground variant="rangoli">
        <section className="bg-lushmilk-cream py-16">
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-2xl mx-auto bg-white/80 p-8 rounded-lg shadow-lg kolam-border">
