    ...
    <Layout>
      ...
      <section className="hero-section text-white">
        ...
        <div className="container mx-auto relative z-10 animate-fade-in">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">LushMilk – The Taste of Purity</h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">Experience the goodness of farm-fresh milk, delivered directly to your doorstep.</p>
      ...
      {/* About Section */}
      <section className="section-padding bg-lushmilk-offwhite kolam-pattern">
